...
import 'hotel_password_model.dart';
export 'hotel_password_model.dart';

class HotelPasswordWidget extends StatefulWidget {
  const HotelPasswordWidget({
    super.key,
  ...
  @override
  State<HotelPasswordWidget> createState() => _HotelPasswordWidgetState();
}

class _HotelPasswordWidgetState extends State<HotelPasswordWidget> {
  late HotelPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HotelPasswordModel());
