...
class _UpdateHotelWidgetState extends State<UpdateHotelWidget> {
  ...
  void initState() {
    ...
    _model.contactController1 ??=
        TextEditingController(text: widget.hotelRef?.hotelName);
    _model.contactFocusNode1 ??= FocusNode();

    _model.contactController2 ??=
        TextEditingController(text: widget.hotelRef?.hotelContactno);
    _model.contactFocusNode2 ??= FocusNode();

    _model.emailController ??=
        TextEditingController(text: widget.hotelRef?.hotelEmail);
    _model.emailFocusNode ??= FocusNode();

    _model.roomsController ??=
        TextEditingController(text: widget.hotelRef?.noOfRooms.toString());
    _model.roomsFocusNode ??= FocusNode();

    _model.ratingController ??=
        TextEditingController(text: widget.hotelRef?.locationName);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.contactController1Validator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.contactController2Validator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.roomsControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.ratingControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Container(
                              ...
                              StreamBuilder<List<RoomRecord>>(
                                stream: queryRoomRecord(
                                  queryBuilder: (roomRecord) =>
                                      roomRecord.where(
                                    'hotelRef',
                                    isEqualTo: widget.hotelRef?.reference,
                                  ),
                                ),
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              'updateRooms',
                                              queryParameters: {
                                                'roomPara': serializeParam(
                                                  listViewRoomRecord,
                                                  ParamType.Document,
                                                ),
                                              }.withoutNulls,
                                              extra: <String, dynamic>{
                                                'roomPara': listViewRoomRecord,
                                              },
                                            );
                                          },
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await widget.hotelRef!.reference
                                  .update(createHotelRecordData(
                              ...
                              context.pushNamed('manageHotels');
                            },
                            text: 'Save ',
