  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<DestinationRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DestinationRecord> adminMapDestinationRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final adminMapDestinationRecord =
            adminMapDestinationRecordList.isNotEmpty
                ? adminMapDestinationRecordList.first
                : null;
              ...
              children: [
                Row(
                  ...
                  children: [
                    FlutterFlowPlacePicker(
                      iOSGoogleMapsApiKey:
                          'AIzaSyAHDJhvuWHiPJYNEIwuvj7ERVJFrgjdLqc',
                      androidGoogleMapsApiKey:
                          'AIzaSyD5-3AmRQ88TUvCFFMK2PPS72XYtHCfGO4',
                      webGoogleMapsApiKey:
                          'AIzaSyCCo1egMw_rjdZixmBw01FrNQj-YknmPYY',
                ...
                Expanded(
                  child: Builder(builder: (context) {
                    final googleMapMarker = adminMapDestinationRecord;
