  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AdminRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AdminRecord> authenticationAdminRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final authenticationAdminRecord =
            authenticationAdminRecordList.isNotEmpty
                ? authenticationAdminRecordList.first
                : null;
                                      ...
                                      child: Padding(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            ...
                                            fadeOutDuration:
                                                const Duration(milliseconds: 500),
                                            imageUrl: authenticationAdminRecord!
                                                .photoUrl,
                                            width: 44.0,
                                            height: 44.0,
                                            fit: BoxFit.cover,
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              '${listViewUserRecord.role} Request',
                                              maxLines: 1,
                                            ...
                                            Padding(
                                              padding: const EdgeInsetsDirectional
                                                  .fromSTEB(0.0, 4.0, 0.0, 0.0),
                                              child: Text(
                                                '${listViewUserRecord.displayName} has requested to register as ${listViewUserRecord.role} Owner.',
                                                maxLines: 2,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(10.0),
                                                        child: Image.network(
                                                          'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw2fHxtZW58ZW58MHx8fHwxNzAxNzkwODMyfDA&ixlib=rb-4.0.3&q=80&w=1080',
                                                          width: 44.0,
                                                          height: 44.0,
                                                          fit: BoxFit.cover,
                                                        ),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        FlutterFlowIconButton(
                                          ...
                                          borderWidth: 1.0,
                                          buttonSize: 33.0,
                                          fillColor: const Color(0xFFE74852),
                                          hoverColor: const Color(0xFFC21A27),
                                          icon: Icon(
                                            Icons.close,
                                        ...
                                        Padding(
                                          ...
                                          child: FlutterFlowIconButton(
                                            ...
                                            hoverColor: const Color(0xFF01469E),
                                            icon: Icon(
