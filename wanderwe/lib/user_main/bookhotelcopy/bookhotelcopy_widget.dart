...
import 'bookhotelcopy_model.dart';
export 'bookhotelcopy_model.dart';

class BookhotelcopyWidget extends StatefulWidget {
  const BookhotelcopyWidget({super.key});

  @override
  State<BookhotelcopyWidget> createState() => _BookhotelcopyWidgetState();
}

class _BookhotelcopyWidgetState extends State<BookhotelcopyWidget> {
  late BookhotelcopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookhotelcopyModel());
