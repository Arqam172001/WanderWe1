...
class _CreateAccountUserWidgetState extends State<CreateAccountUserWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccountUserModel());
                                      ...
                                      onPressed: () async {
                                        ...
                                        await currentUserReference!.update({
                                          ...createUserRecordData(
                                            ...
                                            cnic: _model.cnicController.text,
                                            role: 'user',
                                            phoneNumber: _model
